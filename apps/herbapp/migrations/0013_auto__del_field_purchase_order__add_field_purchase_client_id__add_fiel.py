...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Purchase.order'
        db.delete_column(u'herbapp_purchase', 'order')

        # Adding field 'Purchase.client_id'
        db.add_column(u'herbapp_purchase', 'client_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=48, primary_key=True),
                      keep_default=False)

        # Adding field 'Purchase.app_region'
        db.add_column(u'herbapp_purchase', 'app_region',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'Purchase.screen_height'
        db.add_column(u'herbapp_purchase', 'screen_height',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Purchase.order'
        raise RuntimeError("Cannot reverse this migration. 'Purchase.order' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Purchase.order'
        db.add_column(u'herbapp_purchase', 'order',
                      self.gf('django.db.models.fields.CharField')(max_length=32, primary_key=True),
                      keep_default=False)

        # Deleting field 'Purchase.client_id'
        db.delete_column(u'herbapp_purchase', 'client_id')

        # Deleting field 'Purchase.app_region'
        db.delete_column(u'herbapp_purchase', 'app_region')

        # Deleting field 'Purchase.screen_height'
        db.delete_column(u'herbapp_purchase', 'screen_height')
