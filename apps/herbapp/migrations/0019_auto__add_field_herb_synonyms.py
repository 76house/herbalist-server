...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Herb.synonyms'
        db.add_column(u'herbapp_herb', 'synonyms',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Herb.synonyms'
        db.delete_column(u'herbapp_herb', 'synonyms')
    ...
    models = {
        ...
        u'herbapp.herb': {
            ...
            'synonyms': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'})
        },
        u'herbapp.herbpick': {
