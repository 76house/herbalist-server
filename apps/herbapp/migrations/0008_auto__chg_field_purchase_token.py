...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        # Changing field 'Purchase.token'
        #db.alter_column('herbapp_purchase', 'token', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):
        pass

        # Changing field 'Purchase.token'
        #db.alter_column('herbapp_purchase', 'token', self.gf('django.db.models.fields.CharField')(max_length=16))
