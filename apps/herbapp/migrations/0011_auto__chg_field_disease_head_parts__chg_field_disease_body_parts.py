...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Disease.head_parts'
        db.alter_column('herbapp_disease', 'head_parts', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=14, null=True))

        # Changing field 'Disease.body_parts'
        db.alter_column('herbapp_disease', 'body_parts', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=16, null=True))

    def backwards(self, orm):

        # Changing field 'Disease.head_parts'
        db.alter_column('herbapp_disease', 'head_parts', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=14))

        # Changing field 'Disease.body_parts'
        db.alter_column('herbapp_disease', 'body_parts', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=16))
