...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Herb.author'
        db.delete_column('herbapp_herb', 'author_id')

        # Adding field 'Herb.author_id'
        db.add_column('herbapp_herb', 'author_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['herbapp.Author']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Herb.author'
        db.add_column('herbapp_herb', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['herbapp.Author']),
                      keep_default=False)

        # Deleting field 'Herb.author_id'
        db.delete_column('herbapp_herb', 'author_id_id')
