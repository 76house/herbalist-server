...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HerbPick.note_en'
        db.add_column('herbapp_herbpick', 'note_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'HerbPick.note_cs'
        db.add_column('herbapp_herbpick', 'note_cs',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'HerbUsage.note_en'
        db.add_column('herbapp_herbusage', 'note_en',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'HerbUsage.note_cs'
        db.add_column('herbapp_herbusage', 'note_cs',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Disease.affected_sex'
        db.add_column('herbapp_disease', 'affected_sex',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Disease.age_group'
        db.add_column('herbapp_disease', 'age_group',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HerbPick.note_en'
        db.delete_column('herbapp_herbpick', 'note_en')

        # Deleting field 'HerbPick.note_cs'
        db.delete_column('herbapp_herbpick', 'note_cs')

        # Deleting field 'HerbUsage.note_en'
        db.delete_column('herbapp_herbusage', 'note_en')

        # Deleting field 'HerbUsage.note_cs'
        db.delete_column('herbapp_herbusage', 'note_cs')

        # Deleting field 'Disease.affected_sex'
        db.delete_column('herbapp_disease', 'affected_sex')

        # Deleting field 'Disease.age_group'
        db.delete_column('herbapp_disease', 'age_group')
    ...
    models = {
        ...
        'herbapp.disease': {
            ...
            'age_group': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'default': "''", 'max_length': '15'}),
        ...
        'herbapp.herbpick': {
            ...
            'note_cs': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'note_en': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'})
        },
        'herbapp.herbpicture': {
